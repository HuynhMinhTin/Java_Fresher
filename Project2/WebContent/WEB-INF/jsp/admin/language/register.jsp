...
<body>
	<div class="card">
              ...
              <div class="card-body">
                <s:form class="form-horizontal" action="${pageContext.request.contextPath }/admin/language/insert.html"
                enctype="multipart/form-data"  method="POST" commandName="languages" >
                 <div class="form-group">
                    <label class="control-label col-md-3">Id</label>
                    <div class="col-md-8">
                      <s:input class="form-control" type="text" placeholder="Enter Fullname" path="id"/>
                      <div class="form-group has-error">
							<s:errors class="control-label" type="text" path="id"
								for="inputError" />
						</div>
                    </div>
                  </div>
