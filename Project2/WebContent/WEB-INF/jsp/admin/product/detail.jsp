                ...
                <s:form class="form-horizontal" action="${pageContext.request.contextPath }/admin/product/detail/edit/${productId }.html" commandName="products" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <s:hidden class="form-control"  path="images"/>
                      <img alt="" src="${pageContext.request.contextPath }/assets/user/images/${products.images}" style="height: 200px;width: 200px;margin: 0 auto;display: block;" >
                      <br><br>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <s:textarea class="form-control" type="text" placeholder="Enter Descriptions" path="descriptions"/>
                       <div class="form-group has-error">
