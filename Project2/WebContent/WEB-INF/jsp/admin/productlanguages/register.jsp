...
<body>
	<div class="card">
              ...
              <div class="card-body">
                <s:form class="form-horizontal" action="${pageContext.request.contextPath }/admin/productlanguages/insert.html"
                enctype="multipart/form-data"  method="POST" commandName="pls" >
